...
// node_modules/hijri-date/lib/DateConverter.js
var require_DateConverter = __commonJS({
  "node_modules/hijri-date/lib/DateConverter.js"(exports) {
    "use strict";
    ...
    function GregToIsl(arg) {
      ...
      var jd = void 0, l = void 0, jd1 = void 0, n = void 0, j = void 0, delta2 = 1;
      if (y > 1582 || y == 1582 && m > 10 || y == 1582 && m == 10 && d > 14) {
        jd = intPart(1461 * (y + 4800 + intPart((m - 14) / 12)) / 4) + intPart(367 * (m - 2 - 12 * intPart((m - 14) / 12)) / 12) - intPart(3 * intPart((y + 4900 + intPart((m - 14) / 12)) / 100) / 4) + d - 32075 + delta2;
      } else {
        jd = 367 * y - intPart(7 * (y + 5001 + intPart((m - 9) / 7)) / 4) + intPart(275 * m / 9) + d + 1729777 + delta2;
      }
      jd1 = jd - delta2;
      l = jd - 1948440 + 10632;
      n = intPart((l - 1) / 10631);
    ...
    function IslToGreg(arg) {
      ...
      var l = void 0, n = void 0, i = void 0, j = void 0, k = void 0;
      if (jd > 2299160) {
        l = jd + 68569;
...
// node_modules/hijri-date/lib/StringDateParser.js
var require_StringDateParser = __commonJS({
  "node_modules/hijri-date/lib/StringDateParser.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var StringDateParser = (function() {
      function StringDateParser2() {
        _classCallCheck(this, StringDateParser2);
      }
      _createClass(StringDateParser2, null, [{
        key: "extract",
        value: function extract(string, format, formatChunk) {
          var ignoreCase = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true;
      ...
      return StringDateParser2;
    })();
    exports.default = StringDateParser;
  }
});

// node_modules/hijri-date/lib/initializer.js
var require_initializer = __commonJS({
  "node_modules/hijri-date/lib/initializer.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _DateConverter = require_DateConverter();
    var _StringDateParser = require_StringDateParser();
    ...
    var Initializer = (function() {
      ...
      _createClass(Initializer2, null, [{
        key: "initDefault",
        value: function initDefault() {
          return (0, _DateConverter.GregToHijri)(/* @__PURE__ */ new Date());
        }
      }, {
        key: "init_number",
        ...
        value: function initFromNumbers(year, month, date) {
          ...
          var minutes = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : 0;
          var _arguments = arguments;
          var seconds = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : 0;
          var milliseconds = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : 0;
        ...
        value: function initFromStrings(dateString) {
          var format = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : defaultFormat;
          var props = {};
...
// node_modules/hijri-date/lib/FormatDate.js
var require_FormatDate = __commonJS({
  "node_modules/hijri-date/lib/FormatDate.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    var dateFormat = /* @__PURE__ */ (function() {
      var token = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g, timezone = /\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g, timezoneClip = /[^-+\dA-Z]/g, pad = function pad2(val, len) {
        val = String(val);
        len = len || 2;
      ...
      return function(date, mask) {
        ...
        var _require$default = require_HijriDate().default, locales = _require$default.locales, defaultLocale = _require$default.defaultLocale;
        ...
        var _ = options.utc ? "getUTC" : "get", d = date[_ + "Date"](), D = date[_ + "Day"](), m = date[_ + "Month"](), mIndex = date[_ + "MonthIndex"](), y = date[_ + "FullYear"](), H = date[_ + "Hours"](), M = date[_ + "Minutes"](), s = date[_ + "Seconds"](), L = date[_ + "Milliseconds"](), o = options.utc ? 0 : date.getTimezoneOffset(), flags = {
          d,
          dd: pad(d),
...
// node_modules/hijri-date/lib/locales.js
var require_locales = __commonJS({
  "node_modules/hijri-date/lib/locales.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/hijri-date/lib/HijriDate.js
var require_HijriDate = __commonJS({
  "node_modules/hijri-date/lib/HijriDate.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.dateProps = void 0;
    ...
    var HijriDate = (function() {
      function HijriDate2() {
        _classCallCheck(this, HijriDate2);
        return this.init.apply(this, arguments);
      }
      _createClass(HijriDate2, [{
        key: "init",
        value: function init() {
          var _this = this;
          var props = {};
        ...
        value: function addSeconds(n) {
          return this.addMilliseconds(1e3 * n);
        }
      }, {
        key: "addMilliseconds",
        ...
        value: function subtractSeconds(n) {
          return this.subtractMilliseconds(1e3 * n);
        }
      }, {
        ...
        value: function format(mask, options) {
          return _FormatDate2.default.apply(void 0, [this].concat(Array.prototype.slice.call(arguments)));
        }
      }, {
        key: "ignoreTime",
        ...
        value: function clone() {
          return new HijriDate2(this.time);
        }
      }, {
        key: "is",
        value: function is() {
        ...
        value: function isToday() {
          return HijriDate2.today().time == this.clone().ignoreTime().time;
        }
      }, {
        key: "isYesterday",
        value: function isYesterday() {
          return HijriDate2.yesterday().time == this.clone().ignoreTime().time;
        }
      }, {
        key: "isTomorrow",
        value: function isTomorrow() {
          return HijriDate2.tomorrow().time == this.clone().ignoreTime().time;
        }
      }, {
        key: "valueOf",
        ...
        value: function today() {
          return new HijriDate2().ignoreTime();
        }
      }, {
        key: "yesterday",
...
// node_modules/hijri-date/lib/safe.js
var require_safe = __commonJS({
  "node_modules/hijri-date/lib/safe.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.toHijri = void 0;
    var _HijriDate = require_HijriDate();
    var _HijriDate2 = _interopRequireDefault(_HijriDate);
    var _DateConverter = require_DateConverter();
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    var toHijri = exports.toHijri = function toHijri2(gregDate) {
      var _GregToHijri = (0, _DateConverter.GregToHijri)(gregDate), year = _GregToHijri.year, month = _GregToHijri.month, date = _GregToHijri.date;
...
// node_modules/hijri-date/lib/index.js
var require_lib = __commonJS({
  "node_modules/hijri-date/lib/index.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/hijri-date/index.js
var require_hijri_date = __commonJS({
  "node_modules/hijri-date/index.js"(exports, module) {
    module.exports = require_lib();
  }
});
export default require_hijri_date();
//# sourceMappingURL=hijri-date.js.map
